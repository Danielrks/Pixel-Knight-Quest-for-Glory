...
func _physics_process(delta: float) -> void:
	...
	if Input.is_action_just_pressed("Left_Click") and not Input.is_action_just_pressed("ui_left") and not Input.is_action_pressed("ui_right") and current_animation != "fall" and played_attack == false and Mana >= 12: #and current_animation != "damaged":
